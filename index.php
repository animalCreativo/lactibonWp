...
<head>
   <!-- Global site tag (gtag.js) - Google Analytics -->
    <script async src="https://www.googletagmanager.com/gtag/js?id=UA-108616933-1"></script>
    <script>
      window.dataLayer = window.dataLayer || [];
      function gtag(){dataLayer.push(arguments);}
      gtag('js', new Date());

      gtag('config', 'UA-108616933-1');
    </script>
...
<body>
        ...
        <div class="row" style="padding: 0px;" id="rowMobile">
          ...
          <div class="top-bar show-for-small-only" id="example-menu" style="height: 100vh; width: 100vw; z-index: 1; /* Sit on top */">
            <div class="top-bar-left" style="height: 100%;">
              ...
              <ul class=" dropdown menu" data-magellan data-dropdown-menu id="menuListHeader">
                  <li><a class= "clickMenu" href="#second">Modo de acción</a></li>
              </ul>
              <ul class=" dropdown menu" data-magellan data-dropdown-menu id="menuListHeader">
   ...
   <div class="sections">
    ...
    <section >
      <article id="card23Div" >
        <div class="row container" >
              <div class="small-12 medium-6 columns  card2-section align-self-middle text-center show-for-small-only">
 ...
 <hr size="1px" color="#e4e4e4" style="max-width: 100%;    margin-left: 0px;">
                    ...
                    <nav class="menu-footer-container">
                        <ul id="menu-footer" class="menu footermenu">
                            ...
                            <li id="menu-item-98" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-98">
                                <a href="#second">Modo de acción</a>
                            </li>
